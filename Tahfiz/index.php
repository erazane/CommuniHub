  ...
  <div id="carousel-example-generic" class="carousel slide carousel-fade">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active slide1">
        <h2 data-animation="animated bounceInDown"><span>Welcome To Tahfiz Care</span></h2>
        <h3 data-animation="animated bounceInDown">Tahfiz Care is a platform to provide information, donation and events advertisement from Tahfiz School in Malaysia.</h3>
        <br>
        <h4 data-animation="animated bounceInUp"><a href="registeras.php">REGISTER</a></h4>
      </div>
      <!-- Item 2 -->
      <!-- <div class="item slide2">
        <h2 data-animation="animated bounceInDown"><span>More charity More better life</span></h2>
        <h3 data-animation="animated bounceInDown">Tahfiz Care is a place for the people to have a helping hands to build a bright future of Islamic in Malaysia</h3>
...
<section id="about-sec">
  <div class="container">
    <div class="row text-center">
      <h1>ABOUT TAHFIZ CARE</h1>
      <hr>
      <!-- <h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h5> -->
      <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis
        aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p> -->
      <b>Tahfiz Care application is about enhancing the relations between the muslim society and Tahfiz schools. Tahfiz Care allow Tahfiz Schools to advertise school information, events and donations. Society can use this application to identify and make a comparison between Tahfiz Schools in Malaysia.</b>
      <div class="text-center">
        <!-- <a href="" class="btn1">Register</a> -->
        <a href="aboutus.php" class="btn2">Read More</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row text-center">
      ...
      <div class="text-left">
        ...
        <div class="col-md-4 clearfix top-off">
          ...
          <div class="grid-content-wrapper"><h4>Home for Homeless</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut efficitur eget justo quis dignissim.</p>
            <a href="activities.html" title="" >Read More</a>
          </div>
        </div>
        <div class="col-md-4 clearfix top-off">
          ...
          <div class="grid-content-wrapper"><h4>Bringing Clean Water</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut efficitur eget justo quis dignissim.</p>
            <a href="activities.html" title="" >Read More</a>
          </div>
        </div>
        <div class="col-md-4 clearfix top-off">
          ...
          <div class="grid-content-wrapper"><h4>Help Little Hands</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut efficitur eget justo quis dignissim.</p>
            <a href="activities.html" title="" >Read More</a>
          </div>
        </div>
        <div class="col-md-4 clearfix top-off">
          ...
          <div class="grid-content-wrapper"><h4>Donate for Children</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut efficitur eget justo quis dignissim.</p>
            <a href="activities.html" title="" >Read More</a>
          </div>
        </div>
