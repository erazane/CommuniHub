        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
          <nav class="main_nav">
            <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp" style="list-style:none;">
              ...
              <li><a href="">Where To Study</a>
                <div class="dropdownContain">
                <div class="dropOut">
                      <div class="triangle"></div>
                      <ul>
                      <li><a style="color:#3d526d; font-weight:500;" href="filterschool.php">Search School</a></li>
                      <li><a style="color:#3d526d; font-weight:500;" href="compareschool.php">Compare School</a></li>
                      </ul>
                      </div>
                      </div>
              </li>
