...
<section id="about-sec">
    <div class="container">
        ...
        <div class="col-md submit-button text-center">
          <input type="submit" value="Search by School Level & State" name="searchlevelstate" class="btn2 glyphicon-search" id="submit" style="border:none; margin: 0px 0 0px 0; transform:none;">
          <br>
          <input type="submit" value="Search All" name="searchall" class="btn2 glyphicon-search" id="submit" style="border:none; margin: 10px 0 0px 0; transform:none; background: #118f56;">
      </div>
      <br>
      <?php
    if (isset($_POST['searchall'])) {
       ...
       <div class="col-md-12">
        ...
        WHERE school_name LIKE '%" . $search . "%' && state LIKE '%" . $state . "%' && category_name LIKE '%" . $level . "%' "
                . "&& status='approved'");
   ...
   <?php } ?>
        ...
        <?php } else if (isset($_POST['searchlevelstate'])) {
...
?>
       <div class="col-md-12">
           <?php
            $list = $connection->query("SELECT * FROM schools
        WHERE state LIKE '%" . $state . "%' && category_name LIKE '%" . $level . "%' "
                . "&& status='approved'");
        while ($fetch = $list->fetch_array()) {
           ?>
            <div class="row row-search-result">
