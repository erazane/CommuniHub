           ...
           ?>
            <div class="row row-search-result" style="background: #ffffff; border-radius: 10px; box-shadow: 0px 0px 14px -6px rgba(0,0,0,0.54); margin-bottom: 10px;">
                ...
                <div class="col-md-2 col-sm-12 col-xs-12 margin-t-50 tablet-margin-t-10 mobile-margin-t-10" style="margin-top: 60px;">
                    <a class="btn btn-default btn-search-result btn-black-border btn-add-to-compare track-event-click" href="schoolprofile.php?schools_ID=<?php echo $fetch['schools_ID'] ?>" data-event-id="5216" data-event-name="Add compare" data-school-id="5216" data-loading-text="adding...">
                        View Details
