    ...
    <div class="container">
        <div class="row">
            <div class="text-center">
                <h2>Offline Donation History</h2>
                <hr>
                <div class="submit-button">
                    <a class="btn2" href="onldonationhistory.php" style="border:none; margin: 0px 0 15px 0; background: #ababab; transform:none;">Online</a>

                    <a class="btn2" href="offdonationhistory.php" style="border:none; margin: 0px 0 15px 0; background: #118f56; transform:none;">Offline</a>
                </div>
            </div>
            <div class="col-md-12">
...
$don = $connection->query("SELECT schools.*,donationpaymentoffline.*,parents.*,donation.*
                        ...
                        WHERE  donationpaymentoffline.parents_ID=".$_SESSION['parents_ID']."");
