...
<head>
    ...
    <link rel="stylesheet" href="css/cart.css"> <!-- Resource style -->
...
<body>
    ...
    <nav class="navbar navbar-default navbar-sticky bootsnav">
        <div class="container">
            <div class="row">
                <div class="attr-nav">
                    <a class="login-button" href="loginas.php">Login</a>
                    <a class="join-now-button" href="registeras.php">Register</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <nav class="main_nav">
                        <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp" style="list-style:none;">
                            ...
                            <li><a href="filterschool.php">Where To Study</a></li>
                            ...
                            <li><a href="event.php">Event*</a>
                                <div class="dropdownContain">
                                    <div class="dropOut">
                                        ...
                                        <ul>
                                            <li><a style="color:#3d526d; font-weight:500;" href="index.php">Make Donation</a></li>
                                            <li><a style="color:#3d526d; font-weight:500;" href="index.php">View Donation Report</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
    ...
    <div class="col-sm-4 col-sm-push-8 text-center">
        <!-- <div class="panel panel-default" style="box-shadow: 0px 4px 30px -10px rgba(13,28,39,0.6); width: 320px; margin-top: -1px;">
            <div class="panel-heading" style="text-transform: uppercase; font-weight: 600;">School Comparison
