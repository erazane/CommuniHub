...
<section id="about-sec">
    <div class="container">
        ...
        <div class="row text-center">
          <label style="color: #2578bb; font-weight: 600; font-size: 15px; margin-bottom: 0px;">(Offline Donation)</label>
            <h5 style="font-size: 20px;">You are about to make a donation to:
              <br><br>
            ...
            <?php
                    $sch = $connection->query("SELECT * FROM donation WHERE donation_ID='" . $_GET['donation_ID'] . "'");
                    while ($fetch = $sch->fetch_array()) {
                        ?>
            <h5 style="font-size: 15px; color: #2578bb;">
                (<?php echo $fetch['donationtitle']; ?>)
            </h5>
            <h5 style="font-size: 15px;">Amount Needed: </h5>

            <div class="col-md-2 col-md-offset-5 input-group" style="padding-left: 24px; padding-right: 0px; margin-top: 8px; width: 0px;">
              <span class="input-group-addon" style="font-weight: 600;">
                  RM
              </span>
                <input style="font-weight: 600; width: 100px;" type="text" class="form-control" name="tempamount" readonly="readonly" value="<?php echo $fetch['donationamount'];?>">
            </div>
        ...
        <form action="donationlistformoffline2.php" method="POST" name="image_upload_form" id="myForm" enctype="multipart/form-data">
            <br>
            <div class="row">
                <?php
                ...
                <div class="col-md-6" style="margin-bottom: 15px;">
                    <label>Upload your transaction slip here:</label>

                    <div class="input-group image-preview">
                        <input type="text" class="form-control filename" disabled="disabled" placeholder="Upload a photo here">

                        <span class="input-group-btn" style="font-family: SF Pro Display;">
                            ...
                            <div class="btn image-preview-input">
                                ...
                                <input type="file" name="images_upload[]" id="image_upload_form" accept="image/png, image/jpeg, image/gif" multiple>
                            </div>
                        </span>
                    </div>
                    <label style="color: #757575; font-weight: 400;"><i>*We will verified your donation with the slip and send the donation receipt via email after confirmed receiving your donation.</i></label>
                </div>
                ...
                <div class="col-md-8 form-group" style="margin-bottom: 0px;">
                    ...
                    <div class="col-md-12 radio-group" style="padding-left: 0px; padding-right: 0px; ">
                        <label class="btn btn-amount form-check-label" style="width: 104px; height: 50px; padding-top: 13px; margin-top: 3px">
                            <input class="form-check-input" type="radio" id="option3" autocomplete="off" value="50" name="amount" style="display: none"><span style="font-weight: 600;">RM 50</span>
                        </label>
                        <label class="btn btn-amount form-check-label" style="width: 104px; height: 50px; padding-top: 13px; margin-top: 3px">
                            <input class="form-check-input" type="radio" id="option4" autocomplete="off" value="100" name="amount" style="display: none"><span style="font-weight: 600;">RM 100</span>
                        </label>
                        <label class="btn btn-amount form-check-label" style="width: 104px; height: 50px; padding-top: 13px; margin-top: 3px">
                            <input class="form-check-input" type="radio" id="option5" autocomplete="off" value="150" name="amount" style="display: none"><span style="font-weight: 600;">RM 150</span>
                        </label>
                        <label class="btn btn-amount form-check-label" style="width: 104px; height: 50px; padding-top: 13px; margin-top: 3px">
                            <input class="form-check-input" type="radio" id="option6" autocomplete="off" value="200" name="amount" style="display: none"><span style="font-weight: 600;">RM 200</span>
                        </label>
                        <label class="btn btn-amount form-check-label" style="width: 104px; height: 50px; padding-top: 13px; margin-top: 3px">
                            <input class="form-check-input" type="radio" id="option7" autocomplete="off" value="250" name="amount" style="display: none"><span style="font-weight: 600;">RM 250</span>
                        </label>
                    ...
                    while ($fetch = $sch->fetch_array()) {
                        ?>
                    <div class="col-md-6 form-group" style="padding-left: 0px; margin-top: 10px; margin-bottom: 0px;">
                        <label>Bank Name: <br />
                          <label style="color: #118f56; font-weight: 500;"><?php echo $fetch['bank_name']; ?></label>
                        </label>
                        <br />
                        <label>Account Name: <br />
                          <label style="color: #118f56; font-weight: 500;"><?php echo $fetch['acc_name']; ?></label>
                        </label>
                        <br />
                        <label>Account Number: <br />
                          <label style="color: #118f56; font-weight: 500;"><?php echo $fetch['acc_no']; ?></label>
                        </label>
                    </div>
                    <?php } ?>
                ...
                <div class="col-xs-12 submit-button text-center">
                    <input type="submit" value="Donate" class="btn2" id="myForm" style="border:none; margin: 0px 0 0 0">
                </div>
        </form>
