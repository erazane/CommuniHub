    ...
    <div class="container">
        <div class="row">
          ...
          while ($fetch = $sch->fetch_array()) {
            ...
            <div class="row">
                <div class="col-md-4">
                    <form action="favorite.php" method="post" id="myForm">
                        <div class="profile-card js-profile-card text-center" style="margin-right: 0px;">
                            <div class="profile-card__cnt js-profile-cnt">
                                <!-- <div class="col-xs-12 submit-button text-center">
                                  <input type="submit" value="favorite" name="favstatus"  class="btn2" id="sub" style="border:none; margin: 20px 0 0 0">
                              </div> -->
                                <?php if($checker == 0) { ?>
                                <div class="heart" id="sub1" data-toggle="tooltip" data-placement="bottom" title="Click to favorite" type="text" value="fav" style="left: 260px; top: 0px; .tooltip">
                                    <input type="hidden" value="favorite" name="favstatus">
                                </div>

                                <?php } else if($checker == 1) { ?>

                                <div class="heart2" id="sub2" data-toggle="tooltip" data-placement="bottom" title="Click to unfavorite" type="text" value="fav" style="left: 260px; top: 0px;">
                                    <input type="hidden" value="favorite" name="favstatus">
                                </div>
                              <?php } ?>


                                <!-- <div class="heart" id="sub" type="text" value="fav" style="left: 260px; top: 0px;">
                                  <input type="hidden" value="favorite" name="favstatus">
                              </div>
                              <div class="heart2" id="sub2" type="text" value="fav" style="left: 0px; top: 0px;">
                                  <input type="hidden" value="favorite" name="favstatus">
                              </div> -->



                                <!-- <div class="heart" id="result" style="left: 260px; top: 0px;">
                                </div> -->
