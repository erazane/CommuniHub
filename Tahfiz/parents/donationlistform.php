...
<section id="about-sec">
    <div class="container">
        ...
        <div class="row text-center">
          <label style="color: #029653; font-weight: 600; font-size: 15px; margin-bottom: 0px;">(Online Donation)</label>
            <h5 style="font-size: 20px;">You are about to make a donation to: <br><br>
            ...
            <?php
                    ...
                    while ($fetch = $sch->fetch_array()) {
                        ?>
            <h5 style="font-size: 15px; color: #029653;">
        ...
        <form action="donationlistform2.php" method="post" id="myForm">
            <br>
            <div class="row">
                <?php
