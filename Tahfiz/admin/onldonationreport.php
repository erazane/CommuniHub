          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="overview-wrap">
                      <h2 class="title-1" style="color: #00ad5f">Online Donation Report</h2>
          ...
          <div class="row m-t-30">
                  ...
                  <div class="table-responsive m-b-40">
                      <table class="table table-borderless table-data3 text-center">
                          ...
                          <tbody>
                              <tr>
                                <?php
           $don = $connection->query("SELECT schools.*,donationpayment.*,parents.*
           ...
           while($row2 = $don->fetch_array()){
                   ?>
                                  ...
                                  <td><?php echo date('d/m/Y', strtotime($row2['don_date'])); ?></td>
                                  <td><?php echo $row2['receiptno'];?></td>
                                  <td><?php echo $row2['don_amount'];?></td>
                              </tr>
                              <?php } ?>
                          </tbody>
                      </table>
