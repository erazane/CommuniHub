                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                    <button type="button" class="btn btn-warning" onclick="deleteUser(<?php echo $row['UserID']; ?>)">Delete</button>
                                    <button type="button" class="btn btn-secondary" <?php if($UserType == 'Committee') echo 'disabled'; ?> onclick="window.location.href='assign-committee.php?UserID=<?php echo $row['UserID']; ?>'">Assign</button>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
