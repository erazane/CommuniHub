...
$queryCount = "SELECT COUNT(*) as total FROM paperschedule";
...
$queryHistory = "SELECT PaperPickupDay, Time, DateUpdated
                FROM paperschedule
            ...
            <div class="col-lg-3">
                <div class="pillbox border">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="paper.php">Paper</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <tbody>
                        ...
                        while ($historyRow = mysqli_fetch_assoc($resultHistory)) : ?>
                            <tr>
                                ...
                                <td><?php echo $historyRow['PaperPickupDay']; ?></td>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        ...
                        <?php if ($current_page > 1): ?>
                            <li class="page-item">
                                <a class="page-link" href="history-paper.php?page=<?php echo $current_page - 1; ?>" aria-label="Previous">
                        ...
                        <?php for ($page = 1; $page <= $total_pages; $page++): ?>
                            <li class="page-item <?php echo ($page == $current_page) ? 'active' : ''; ?>">
                                <a class="page-link" href="history-paper.php?page=<?php echo $page; ?>"><?php echo $page; ?></a>
                            </li>
                        <?php endfor; ?>
                        ...
                        <?php if ($current_page < $total_pages): ?>
                            <li class="page-item">
                                <a class="page-link" href="history-paper.php?page=<?php echo $current_page + 1; ?>" aria-label="Next">
